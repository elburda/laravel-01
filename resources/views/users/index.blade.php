        ...
        <table class="table table-bordered table-condensed mb-0">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td>{{ $user->rustdesk ?? 'No disponible' }}</td>
        ...
        <table class="table table-bordered table-condensed mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-grid gap-1">
                            <a href="{{ route('users.edit', ['user' => $user->id]) }}" class="btn btn-secondary btn-sm w-100">✏️ Editar</a>
                            <a href="{{ route('users.delete', ['user' => $user->id]) }}" class="btn btn-danger btn-sm w-100">🗑️ Eliminar</a>
                        </div>
                    </td>
                    @endif
                </tr>
